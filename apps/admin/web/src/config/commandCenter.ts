    ...
    commands: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "SCHEDULED_AT",
            type: "text",
            placeholder: "2026-03-01T10:30:00Z",
            required: false,
          },
        ],
      },
      ...
      {
        id: "mark_as_scheduled",
        name: "MARK_AS_SCHEDULED",
        description: "Mark a notification as scheduled with provider metadata",
        endpoint: "/api/v1/admin/command",
        method: "POST",
        category: "INTERNAL_OPS",
        fields: [
          ...
          },
          {
            ...
            label: "EXTERNAL_ID",
            type: "text",
            placeholder: "provider-schedule-id-123",
            required: false,
            description: "External provider schedule/message ID",
          },
          {
            name: "provider",
            label: "PROVIDER",
