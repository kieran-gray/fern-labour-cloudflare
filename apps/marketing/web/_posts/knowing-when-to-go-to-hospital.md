...
1.  **Frequency:** Contractions are **3 minutes** apart.
2.  **Duration:** Each contraction lasts **1 minute**.
3.  **Consistency:** This pattern has been happening for **1 hour**.
...
1.  **Frequency:** Contractions are **5 minutes** apart.
2.  **Duration:** Each contraction lasts **1 minute**.
3.  **Consistency:** This pattern has been happening for **1 hour**.
