...
import { Container, Title, Text, SimpleGrid, ThemeIcon, Group, Box } from '@mantine/core';
...
export default function BlogIndex({ posts }: BlogIndexProps) {
    return (
        <>
            ...
            <div style={{ backgroundColor: '#fdfaf8', minHeight: '100vh', paddingBottom: 'var(--mantine-spacing-xl)' }}>
                <Container size="lg" pt={{ base: 40, sm: 80 }} pb={{ base: 40, sm: 80 }} px={{ base: 20, sm: 40 }}>
                    <Box mb={60} style={{ maxWidth: 700 }}>
                        ...
                        <Text size="lg" c="dimmed" lh={1.6}>
                            Welcome to our quiet corner of the internet. We write about Fern Labour and how to use it during labour.
                            Straightforward stuff about contractions, your circle, and staying present when it matters.
                        </Text>
                    </Box>
